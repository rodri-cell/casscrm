    ...
    <DashboardLayout requiredRole="agency">
      <div className="p-8 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          {[
            { label: "Clientes Activos", value: activeClients, sub: `de ${MOCK_CLIENTS.length} totales`, icon: "👥", color: "#6366f1" },
            { label: "Campañas Activas", value: activeCampaigns, sub: `de ${MOCK_CAMPAIGNS.length} totales`, icon: "🚀", color: "#0ea5e9" },
